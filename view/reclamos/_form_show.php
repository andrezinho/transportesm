...
<div class="ui-widget-header ui-corner-all" style="padding:5px">
                Busqueda de Reclamos: <input type="text" name="nro_reclamo" id="nro_reclamo"  value="<?php echo str_pad($obj->idreclamos, 5,'0',0); ?>" placeholder="Ingrese el Numero de Reclamo" class="ui-widget-content ui-corner-all text" style="width:200px;" />
            ...
            <div class="full_width" style="margin-top:10px;">            
            	<div style="width:720px; margin:0 auto;">
                    <table width="700" border="0" cellpadding="3" cellspacing="0" class="table ui-widget-content ui-corner-all" style="padding:10px">
                      ...
                      <tr>
                        <td colspan="8">
                            <textarea name="acciones" id="acciones" rows="5" cols="83" placeholder="" readonly=""><?php echo $obj->acciones; ?></textarea>
                        </td>
                      </tr>
                      <tr>
