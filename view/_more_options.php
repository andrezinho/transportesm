<script type="text/javascript">
    ...
    function updateHW()
    {
        var hc = $(".contFrm").height(),
                ...
                constt = 69,
                posf = $("#foot").offset();
        $("#div-more-options").height(posf.top - 125);
        $(".contFrm").height(posf.top - 194);
    }
</script>
<div id="div-more-options" class="ui-widget-content">    
    ...
    <ul id="list-more-options">
        ...
        ?>
                <li class="<?php echo $class; ?>">
                    <a  href="<?php echo $r['url'] ?>?controller=<?php echo $r['controlador'] ?>&action=<?php if ($r['accion'] == "") {
            echo "index";
        } else {
            echo $r['accion'];
        } ?>"><?php echo $r['descripcion']; ?></a>
                </li>
                <?php
            }
        }
