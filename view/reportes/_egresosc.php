    ...
    $(document).ready(function(){
            ...
            if(valid())
                {
                    ...
                    $.get('index.php','controller=reportes&action=html_egresosc&'+str,function(data){
        ...
        $("#pdf").click(function(){
            if(valid())
                {
                    var str = $("#frm").serialize();
                    window.open('index.php?controller=reportes&action=pdf_egresosc&'+str,"Reporte");
                }
        });
    });
    function valid()
...
<h6 class="ui-widget-header">Reporte Egresos de Caja Chica por Fechas</h6>
