...
class PDF extends FPDF
{
        ...
        public function setValues($article,$unidad,$maxw,$widths, $subtitle)
        {
	...
	{                
        ...
        $this->Ln();
        $this->SetXY(9,8);
        $this->Write(0,'REPORTE DE TELEGIROS');		
		...
		$this->SetFillColor(245, 245, 245);
                ...
                $this->Cell($this->widths[11], $h, 'DESTINO', $border, 0, 'C',$fill);
	...
	function FancyTable($rowsi,$rows)
	{
            ...
            foreach($rowsi as $r)
            {
                ...
                $this->Cell($w[11], $h,$r['destino'], $border, 0, 'L', $fill);
...
$maxw=260;
$w = array(8,12,10,45,15,45,45,15,15,10,14,35);
$pdf->setValues($rowsi[0]['fecha'], $rowsi[0]['hora'], $maxw,$w,"Desde ".$_GET['fechai']." hasta ".$_GET['fechaf']);
$orientacion = 'L';
