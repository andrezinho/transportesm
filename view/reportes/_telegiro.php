     ...
     if(valid())
        {
            ...
            $.get('index.php','controller=reportes&action=html_telegiro&'+str,function(data){
        ...
        $("#pdf").click(function(){
                ...
                {              
                    var str = $("#frm").serialize();
					window.open('index.php?controller=reportes&action=pdf_telegiro&'+str,"Reporte");
				}
        });
...
<h6 class="ui-widget-header">Reporte de Telegiros</h6>
    ...
    <form name="frm" id="frm" action="" method="get">        
        ...
        <select name="filtro" id="filtro">
            ...
            <optgroup label="EMITIDOS">
                <option value="1">TODOS LOS TELEGIROS EMITIDOS</option>            
                <option value="2">TELEGIROS EMITIDOS CON CONTRA-ENTREGA</option>
                <option value="3">TELEGIROS EMITIDOS CON ENTREGA A DOMICILIO</option>    
            </optgroup>
            <optgroup label="RECIBIDOS">
                <option value="4">TODOS LOS TELEGIROS RECIBIDOS</option>
                <option value="5">TELEGIROS RECIBIDOS CON CONTRA-ENTREGA</option>
                <option value="6">TELEGIROS RECIBIDOS CON ENTREGA A DOMICILIO</option>
            </optgroup>
        </select>
    </form>
    </fieldset>
