    ...
    $(document).ready(function(){
            ...
            if(valid())
                {
                    ...
                    $.get('index.php','controller=reportes&action=html_mensualidades&'+str,function(data){
        ...
        $("#pdf").click(function(){
            if(valid())
                {
                    var str = $("#frm").serialize();
                    window.open('index.php?controller=reportes&action=pdf_mensualidades&'+str,"Reporte");
                }
        });
    });
    function valid()
...
<h6 class="ui-widget-header">Reporte Mensualidades</h6>
